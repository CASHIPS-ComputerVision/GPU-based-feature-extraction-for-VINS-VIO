...
namespace MultiColSLAM
{
	...
	public:
		...
		void SetExtractorCon(mdBRIEFextractorCon* pExtractor);
		void SetReadImage(cReadImage* pReadImage);
		...
		cv::Matx44d GrabImageSet(const std::vector<cv::Mat>& imgSet,const double& timestamp);
	...
	protected:
		...
		mdBRIEFextractorCon* mpExtractor;
